/**
  ******************************************************************************
  * File   : FreeRTOS/TaskManagement_TimeSlicing/main.c 
  * Version: V1.2.7
  * Date   : 2020-11-10
...
/** @addtogroup FreeRTOS_TaskManagement_TimeSlicing
  * @{
  */
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/  
...
static void AppTaskCreate (void)
{
    ...
    xReturn = xTaskCreate(  vTaskLED,   	    // function of task
                            ...
                            NULL,              	// task parameter*/
                            3,                 	// task priority. Note: the smaller number, the lower priority*/
