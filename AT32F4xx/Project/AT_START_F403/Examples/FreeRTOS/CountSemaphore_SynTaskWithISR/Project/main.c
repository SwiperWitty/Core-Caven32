/**
  ******************************************************************************
  * File   : FreeRTOS/CountSemaphore_SynTaskWithISR/main.c 
  * Version: V1.2.7
  * Date   : 2020-11-10
...
/** @addtogroup FreeRTOS_CountSemaphore_SynTaskWithISR
  * @{
  */ 
...
static void vTaskMsgProcess(void *pvParameters)
{
    ...
    App_Printf("2. Enable Timer CC1 interrupt to give counting semaphore\r\n");  
...
static void TMR_CallBack1(void)
{
     ...
     * the semaphore latches the events to allow the task to which interrupts are
     * deferred to process them in turn, without getting lost.
     */
