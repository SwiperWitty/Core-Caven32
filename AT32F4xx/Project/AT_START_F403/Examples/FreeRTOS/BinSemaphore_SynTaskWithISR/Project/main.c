/**
  ******************************************************************************
  * File   : FreeRTOS/BinSemaphore_SynTaskWithISR/main.c 
  * Version: V1.2.7
  * Date   : 2020-11-10
...
static void AppObjCreate(void)
{
    ...
    xHandleBinarySemaphore = xSemaphoreCreateBinary();//The semaphore is created in the 'empty' state
...
/**
  * @brief  Timer3 compare 1 event to give Semaphore
  * @param  None
  * @retval None
  */
static void TMR_CallBack1(void)
...
/**
  * @brief  Timer3 compare 2 event to toggle led4
  * @param  None
  * @retval None
  */
static void TMR_CallBack2(void)
