/**
  ******************************************************************************
  * File   : FreeRTOS/TaskManagement_PriorityChanges/main.c 
  * Version: V1.2.7
  * Date   : 2020-11-10
...
/** @addtogroup FreeRTOS_TaskManagement_PriorityChanges
  * @{
  */
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/  
...
static void vTaskMsgProcess(void *pvParameters)
{
    ...
    App_Printf("2. LED task priority changed testing\r\n");
    ...
    while(1)
    {
        ...
        switch(ucCommandValue)
        {
            ...
            case '2':
                ...
                {
                      /* vTaskPrioritySet() must only be called from an executing task */
                    vTaskPrioritySet(xHandleTaskLED,1);//LED task's priority is changed to 1
                    App_Printf("\r\nLED task's new priority is %d\r\n\r\n", uxTaskPriorityGet(xHandleTaskLED));
                }
                else
                {
                    App_Printf("LED task is not present\r\n");
                }
                break;
            default:
                break;
        ...
        if(ucCommandValue =='1' || ucCommandValue =='2' )
        {
