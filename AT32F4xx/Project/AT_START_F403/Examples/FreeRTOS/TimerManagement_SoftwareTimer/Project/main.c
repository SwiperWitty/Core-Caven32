/**
  ******************************************************************************
  * File   : FreeRTOS/TimerManagement_SoftwareTimer/main.c 
  * Version: V1.2.7
  * Date   : 2020-11-10
...
/** @addtogroup FreeRTOS_TimerManagement_SoftwareTimer
  * @{
  */
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/  
 ...
 */
/**
 * @brief   Print one shot timer count
 * @param   xTimer:Timer name
 * @retval  None
 */
static void prvOneShotTimerCallback(TimerHandle_t xTimer)
{
...
/**
 * @brief   Print auto reload timer count 
 * @param   xTimer:Timer name
 * @retval  None
 */
static void prvAutoReloadTimerCallback(TimerHandle_t xTimer)
