...
#define SYSCLK_FREQ_HSI  144000000//144000000
/* Clock Definitions */
...
#ifdef SYSCLK_FREQ_HSI/* HSI Selected as System Clock source */
...
void SystemCoreClockUpdate (void)
{
  ...
  {
    case 0x00:
      SystemCoreClock = SYSCLK_FREQ_HSI;
      break;
    case 0x04:  
      SystemCoreClock = SYSCLK_FREQ_HSI;
      break;
    case 0x08: 
      ...
      if (pllsource == 0x00)
      {
        SystemCoreClock = (SYSCLK_FREQ_HSI >> 1) * pllmull;
      }
      else
      {    
        if ((RCC->CFGR0 & RCC_PLLXTPRE) != (uint32_t)RESET)
        {
          ...
          SystemCoreClock = ((SYSCLK_FREQ_HSI>>2) >> 1) * pllmull;
#else
          SystemCoreClock = (SYSCLK_FREQ_HSI >> 1) * pllmull;
#endif
        }
        ...
        {
#if defined (CH32V20x_D8) || defined (CH32V20x_D8W)
            SystemCoreClock = (SYSCLK_FREQ_HSI>>2) * pllmull;
#else
          SystemCoreClock = SYSCLK_FREQ_HSI * pllmull;
#endif
        }
      }
